...
// end include: preamble.js
  ...
  function _DsoError(stringifiedMessage) {
  ...
  function _DsoFormatPrice(stringifiedMessage) {
  ...
  function _DsoGetQueryObject(stringifiedMessage) {
          const { nonce, app_hash } = JSON.parse(UTF8ToString(stringifiedMessage));
          const hiRpc = window.dso_hirpc;
  ...
  function _DsoLocalStorageClear() {
          localStorage.clear();
      }

  function _DsoLocalStorageGetItem(stringifiedMessage) {
  ...
  function _DsoPatchUrlMappings(stringifiedMessage) {
          const { nonce, data, app_hash } = JSON.parse(UTF8ToString(stringifiedMessage));
...
var wasmImports = {
  "DsoCloseDownwardFlow": _DsoCloseDownwardFlow,
  "DsoEmptyRequest": _DsoEmptyRequest,
  "DsoError": _DsoError,
  "DsoExpandCanvas": _DsoExpandCanvas,
  "DsoFormatPrice": _DsoFormatPrice,
  "DsoGetQueryObject": _DsoGetQueryObject,
  "DsoLocalStorageClear": _DsoLocalStorageClear,
  "DsoLocalStorageGetItem": _DsoLocalStorageGetItem,
  "DsoLocalStorageSetItem": _DsoLocalStorageSetItem,
  "DsoLog": _DsoLog,
  "DsoOpenDownwardFlow": _DsoOpenDownwardFlow,
  "DsoPatchUrlMappings": _DsoPatchUrlMappings,
  "DsoSendToJs": _DsoSendToJs,
  "DsoSendToRpc": _DsoSendToRpc,
  "DsoWarn": _DsoWarn,
